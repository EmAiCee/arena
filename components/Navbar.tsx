        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/book" className="text-gray-700 hover:text-blue-600 transition font-medium">
                Book Arena
              </Link>
              {user && (
                <Link href="/my-bookings" className="text-gray-700 hover:text-blue-600 transition font-medium">
                  My Bookings
                </Link>
              )}
                ...
                <>
                  {user ? (
                    <div className="flex items-center space-x-4">
                      ...
                      <button
                        onClick={logout}
                        className="px-4 py-2 text-red-600 hover:text-red-700 transition font-medium"
                      >
                        Logout
                      </button>
                    </div>
                    ...
                    <>
                      ...
                      <button
                        onClick={() => setShowAuthModal(true)}
                        className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-medium hover:shadow-lg transition transform hover:scale-105"
                      >
                        Sign Up Free
                      </button>
                    </>
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 space-y-3 border-t border-gray-200 mt-2 animate-fade-in-up bg-white">
              ...
              <Link href="/book" className="block py-2 text-gray-700 hover:text-blue-600 font-medium">
                Book Arena
              </Link>
              {user && (
                <Link href="/my-bookings" className="block py-2 text-gray-700 hover:text-blue-600 font-medium">
                  My Bookings
                </Link>
              )}
                ...
                {user ? (
                  ...
                  <>
                    <button
                      ...
                      className="w-full text-left text-blue-600 font-medium py-2"
                    >
                      Login
                    </button>
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-full font-medium"
                    >
                      Sign Up Free
                    </button>
                  </>
